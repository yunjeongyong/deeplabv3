...
network = DeepLabV3(model_id, project_dir="E:\\dataset\\Synthetic_Rain_Datasets\\deeplabv3").cuda()

train_dataset = DatasetTrain(cityscapes_data_path="E:\\dataset\\Synthetic_Rain_Datasets\\deeplabv3\\data\\cityscapes",
